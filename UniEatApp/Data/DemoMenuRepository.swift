...
enum SampleMenus {
    ...
    static var all: [DailyMenu] {
        ...
        return [
            ...
            DailyMenu(id: secondID, title: "Tazón completo", validUntil: until, publishedAt: earlier.addingTimeInterval(-600),
                 ...
                 items: [MenuDish(name: "Tazón de hummus", description: "Vegetales, garbanzo y arroz", priceCop: 12_000,
                                 dietaryTags: ["vegetarian", "vegan"], dietaryKnown: true),
                         MenuDish(name: "Tazón de pollo teriyaki", priceCop: 14_000, dietaryKnown: true)],
